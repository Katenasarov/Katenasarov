...
|**Многоцелевая модель для NER и классификации** https://github.com/Katenasarov/text-autocomplete | Разработка единой multi-task модели для совместного решения задач распознавания именованных сущностей (NER) и классификации событий. | *Multi-Task Learning RuBERT NER + Text Classification Hugging Face*|
